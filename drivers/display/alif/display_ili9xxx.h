...
struct alif_ili9xxx_quirks {
	enum madctl_cmd_set cmd_set;
};

struct alif_ili9xxx_config {
	const struct alif_ili9xxx_quirks *quirks;
...
int alif_ili9xxx_transmit(const struct device *dev, uint8_t cmd,
