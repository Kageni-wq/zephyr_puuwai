...
#define ILI9488_REGS_INIT(n)                                                   \
	static const struct ili9488_regs ili9488_regs_##n = {                  \
		.frmctr1 = DT_PROP(DT_INST(n, ilitek_ili9488_alif), frmctr1),       \
		.disctrl = DT_PROP(DT_INST(n, ilitek_ili9488_alif), disctrl),       \
		.pwctrl1 = DT_PROP(DT_INST(n, ilitek_ili9488_alif), pwctrl1),       \
		.pwctrl2 = DT_PROP(DT_INST(n, ilitek_ili9488_alif), pwctrl2),       \
		.vmctrl = DT_PROP(DT_INST(n, ilitek_ili9488_alif), vmctrl),         \
		.pgamctrl = DT_PROP(DT_INST(n, ilitek_ili9488_alif), pgamctrl),     \
		.ngamctrl = DT_PROP(DT_INST(n, ilitek_ili9488_alif), ngamctrl),     \
	}
