...
static enum ethernet_hw_caps dwmac_caps(const struct device *dev, struct net_if *iface)
{
...
static int dwmac_set_config(const struct device *dev, struct net_if *iface,
