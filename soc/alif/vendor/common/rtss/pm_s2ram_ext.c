...
#include "pm_s2ram_ext.h"

/* The firmware runs in Secure state; preserve its SAU configuration. */
struct alif_sau_regs {
...
#define _SAU ((struct alif_sau_regs *)0xE000EDD0UL)
...
void alif_pm_s2ram_save_ext_regs(void)
{
	/* Save context */
...
void alif_pm_s2ram_restore_ext_regs(void)
{
	/* Restore context */
#if defined(ICB)
