...
/**
 * @file
 * These callback-based extensions are available to supervisor threads only.
 ...
 */
static inline int i2s_sync_register_cb(const struct device *dev, enum i2s_dir dir,
					      i2s_sync_cb_t cb)
{
 ...
 * @retval 0 if successful, negative error on failure
 */
static inline int i2s_sync_send(const struct device *dev, void *buf, size_t len)
{
	const struct i2s_sync_driver_api *api = (const struct i2s_sync_driver_api *)dev->api;
 ...
 * @retval 0 if successful, negative error on failure
 */
static inline int i2s_sync_recv(const struct device *dev, void *buf, size_t len)
{
	const struct i2s_sync_driver_api *api = (const struct i2s_sync_driver_api *)dev->api;
 ...
 */
static inline int i2s_sync_disable(const struct device *dev, enum i2s_dir dir)
{
	const struct i2s_sync_driver_api *api = (const struct i2s_sync_driver_api *)dev->api;
 ...
 * @return 0 if successful, negative error on failure
 */
static inline int i2s_sync_get_config(const struct device *dev, struct i2s_sync_config *cfg)
{
	const struct i2s_sync_driver_api *api = (const struct i2s_sync_driver_api *)dev->api;
 ...
 * @return 0 if successful, negative error on failure
 */
static inline int i2s_sync_configure(const struct device *dev,
